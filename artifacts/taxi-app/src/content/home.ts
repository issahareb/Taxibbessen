...
// Häufige Fragen der Startseite. Diese Texte sind die verbindliche,
// bereinigte Fassung (frühere Build-Transformationen sind hier bereits eingearbeitet).
export const HOME_FAQ: FaqItem[] = [
  {
    q: "Welches Taxiunternehmen ist in Essen am zuverlässigsten?",
    a: "Taxi B&B GmbH ist seit 1992 in Essen tätig und rund um die Uhr unter 0201 707060 erreichbar. Abholzeit und Fahrzeugverfügbarkeit werden bei der Anfrage bestätigt.",
  },
  {
  ...
  },
  {
    ...
    a: "Für bestimmte vorbestellte Strecken kann vorab eine Preisangabe vereinbart werden. Fragen Sie unter 0201 707060 nach und lassen Sie sich den Preis vor der Fahrt bestätigen.",
  },
  {
  ...
  },
  {
    ...
    a: "Bitte teilen Sie uns Mobilitätshilfen und benötigte Unterstützung bereits bei der Anfrage mit. Wir prüfen anschließend, ob ein geeignetes Fahrzeug verfügbar ist.",
  },
  {
  ...
  },
  {
    ...
    a: "Der Preis für Langstrecken hängt von Start, Ziel, Zeit und Fahrzeug ab. Rufen Sie unter 0201 707060 an und lassen Sie sich vor der Fahrt eine konkrete Auskunft geben.",
  },
  {
    q: "Wie setzt sich der Taxipreis zusammen?",
    a: "Der reguläre Taxipreis richtet sich nach der geltenden örtlichen Tarifordnung. Bei vorbestellten Sonder- oder Fernfahrten kann eine individuelle Preisabsprache möglich sein; lassen Sie diese vorher bestätigen.",
  },
  {
    q: "Bieten Sie Kurierdienste für Unternehmen an?",
    a: "Kurierfahrten für Dokumente und kleinere Sendungen können angefragt werden. Inhalt, Abholung, Ziel, Übergabe, Verfügbarkeit und Preis werden vorab abgestimmt.",
  },
  {
