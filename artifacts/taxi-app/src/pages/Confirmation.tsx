    ...
    return (
      <Layout>
        <div className="min-h-[60vh] flex items-center justify-center flex-col gap-4 px-4">
          ...
          <Button asChild><Link href="/#anfrage">{t("nav_book")}</Link></Button>
        </div>
      </Layout>
    );
  }
    ...
    return (
      <Layout>
        <div className="min-h-[60vh] flex items-center justify-center flex-col gap-4 px-4">
          ...
          <Button asChild><Link href="/#anfrage">{t("conf_new_booking")}</Link></Button>
        </div>
      </Layout>
    );
  }
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            <Button asChild className="w-full sm:w-auto">
              <Link href="/#anfrage">{t("conf_new_booking")}</Link>
            </Button>
